    ...
    <section className='relative flex min-h-screen items-center justify-center overflow-x-clip bg-[#FEFBF6] pt-24 pb-12 lg:pt-32 lg:pb-20'>
      ...
      <div className='relative z-10 mx-auto grid max-w-[1400px] items-center gap-12 px-6 lg:grid-cols-5 lg:gap-20'>
        ...
        <div className='relative z-20 text-left lg:col-span-2'>
          ...
          >
            <button className='group flex items-center justify-center gap-2 rounded-xl bg-[#2C2416] px-8 py-4 text-[#FEFBF6] shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#4A3F30] hover:shadow-xl'>
              <span className="font-medium tracking-wide">
                Start Tracking Free
              </span>
              <ArrowRight className='h-4 w-4 transition-transform group-hover:translate-x-1' />
            </button>
            <button className='rounded-xl border border-[#E8D5B5] px-8 py-4 font-medium text-[#6B5D4F] tracking-wide transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#E8D5B5]/20'>
              View Demo
            </button>
          </motion.div>
